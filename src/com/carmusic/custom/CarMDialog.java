...
public class CarMDialog extends Dialog {

	public CarMDialog(Context context) {
		super(context);
	}

	public CarMDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CarMDialog create() {
			LayoutInflater inflater = (LayoutInflater) mContext
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			final CarMDialog dialog = new CarMDialog(mContext, R.style.XfDialog);
			...
			// 获取对话框布局
			View layout = inflater.inflate(R.layout.music_alert_dialog,
		...
		public CarMDialog show() {
			CarMDialog dialog = create();
			dialog.show();
			return dialog;
		}
